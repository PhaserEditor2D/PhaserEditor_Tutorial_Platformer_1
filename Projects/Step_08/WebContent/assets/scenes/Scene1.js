...
function Scene1(aGame, aParent) {
	...
	this.game.add.sprite(352, 384, 'objects', 'fruit', fruits);

	this.game.add.sprite(427, 384, 'objects', 'fruit', fruits);

	this.game.add.sprite(502, 384, 'objects', 'fruit', fruits);

	this.game.add.sprite(577, 384, 'objects', 'fruit', fruits);

	this.game.add.sprite(652, 384, 'objects', 'fruit', fruits);

	this.game.add.sprite(727, 384, 'objects', 'fruit', fruits);

	this.game.add.sprite(802, 384, 'objects', 'fruit', fruits);

	this.game.add.sprite(877, 384, 'objects', 'fruit', fruits);
